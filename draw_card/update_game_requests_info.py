...
# 添加到字典
def add_to_data(data: dict, fgo_data: dict, game_name: str) -> dict:
    member_dict = {}
    if game_name == 'fgo':
        member_dict = {
            'id': fgo_data['id'],
            'card_id': fgo_data['charid'],
            '头像': fgo_data['icon'],
            '名称': fgo_data['name'],
            '职阶': fgo_data['classes'],
            '星级': fgo_data['star'],
            'hp': fgo_data['lvmax4hp'],
            'atk': fgo_data['lvmax4atk'],
            'card_quick': fgo_data['cardquick'],
            'card_arts': fgo_data['cardarts'],
            'card_buster': fgo_data['cardbuster'],
            '宝具': fgo_data['tprop'],
        }
    if game_name == 'fgo_card':
        member_dict = {
            'id': fgo_data['id'],
            'card_id': fgo_data['equipid'],
            '头像': fgo_data['icon'],
            '名称': fgo_data['name'],
            '星级': fgo_data['star'],
            'hp': fgo_data['lvmax_hp'],
            'atk': fgo_data['lvmax_atk'],
            'skill_e': fgo_data['skill_e'].split('<br />')[: -1],
        }
