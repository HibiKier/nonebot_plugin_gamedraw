from nonebot import on_command, on_regex, require, on_keyword
...
prts_reload = on_keyword({'test'}, priority=1, block=True)
...
# pretty = on_regex('赛马娘?[1-9|一][0-9]{0,2}[抽|井]', priority=5, block=True)
# pretty_update = on_command('更新赛马娘信息', aliases={'更新马娘信息'}, permission=SUPERUSER, priority=1, block=True)
